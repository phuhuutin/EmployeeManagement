...
Main User Story: A manager can create a shift, and the system automatically schedules a background job to evaluate the shift's payroll and attendance records (e.g., Late, Leave Early, Absent). Attendance records expire 30 days after the shift evaluation, and evaluations occur 24 hours after the shift concludes.
